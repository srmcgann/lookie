...
<?
	...
	if($_GET['i']){
		...
		if(mysqli_num_rows($res)){
			...
			$url="http://$_SERVER[HTTP_HOST]/$row[shortName]";
			...
			$link->query($sql);
				...
				<html>
					<head>
						...
						<link rel="stylesheet" type="text/css" href="http://<?echo $_SERVER["HTTP_HOST"];?>/render.css">
						<link rel="shortcut icon" type="image/png" href="http://<?echo $_SERVER["HTTP_HOST"];?>/favicon.png"/>
						<title><?echo $name;?></title>
						<link href="http://<?echo $_SERVER["HTTP_HOST"];?>/zoom/imageviewer.css"  rel="stylesheet" type="text/css" />
						<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
						<script src="http://<?echo $_SERVER["HTTP_HOST"];?>/zoom/imageviewer.js"></script>
						<script src="http://<?echo $_SERVER["HTTP_HOST"];?>/functions2.js"></script>
						<script>
							init=0;
							setInterval(resize,1000);
							url="http://<?echo $_SERVER["HTTP_HOST"]."/$shortName";?>";
						</script>
					</head>
					<body onresize="resize()" onload="resize()">
						...
						<div id="header">
							<a href="." style="color:#abc;text-decoration:none;cursor: pointer;">
								<div style="width:170px;">
									<div style="background:url(http://<?echo $_SERVER['HTTP_HOST']?>/cloud.png);background-size:100% 100%;width:45px;height:35px;float:left;margin-right:10px;"></div>
									LOOKIE
								</div>
							</a>
							<br><br>
						...
						<div id="masterContainer">
							<center>
								<div id="mainDiv">
										<?
										$src="http://{$_SERVER['HTTP_HOST']}/uploads/$base".suffix($type);
										switch($type){
											case "image/jpeg":
											case "image/png":
											case "image/gif":
														...
														echo '<tr>';
															...
															<script>
																...
																$('.rate_widget').each(function(i) {
																	...
																	$.post(
																		'http://<?echo $_SERVER['HTTP_HOST']?>/ratings.php',
																		out_data,
																		function(INFO) {
																			$(widget).data( 'fsr', INFO );
																			set_votes(widget);
						...
						<div class="upload">
							<div id="uploadInner">
								<table class="ADTable">
									...
									<td><span onclick="$('#AD').prop('checked', true);" class="ADOptionLabel" >Delete after 1 hour</span></td></tr>
								</table>
								<hr>
