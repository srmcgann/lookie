							...
							if(mysqli_num_rows($res)){
											...
											<div class="fileInfoDiv">
												<table class="fileInfo">
													<tr>
														...
														<td><?echo strlen($name)<32?$name:substr($name,0,32)."...";?></td>
													</tr>
													<tr>
														<td style="color:#fff;font-weight:300;text-align:center;width:150px;">Views: </td>
														<td><?echo number_format($views);?></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><a href="<?echo "../?i=$shortName"?>" target="_blank"><?echo "http://$_SERVER[HTTP_HOST]/?i=$shortName"?></a></td>
													</tr>
													<tr>
														<td style="color:#fff;font-weight:300;text-align:center;width:150px;">Gallery:</td>
														<td id="galleryVisible<?echo $i?>"><?echo $public?"Visible":"Hidden";?></td>
													</tr>
													<tr>
														<td style="color:#fff;font-weight:300;text-align:center;width:150px;">File Size:</td>
								...
								?>
									<div style="margin-top:25%;font-size:28px;">
										No Results.<br><br><br>
										<span style="font-size:16px;"><?echo $sql;?></span>
									</div>
								<?
							}
						}else{
